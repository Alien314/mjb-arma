...
// Tarkov Vests
  ...
  VESTMED(RedutM_vest);
  VESTMED(RedutMAssault_vest);
  VESTMED(RedutMBearing_vest);
  VESTMED(RedutMBlackRock_vest);
  VESTMED(RedutMD3CRX_vest);
  VESTMED(RedutMMK3_vest);
  VESTMED(RedutMThunderbolt_vest);
  VESTMED(RedutMTriton_vest);
  VESTMED(RedutMTV109_vest);

  VESTMED(Slick_vest);
  VESTMED(SlickAssault_vest);
  VESTMED(SlickBearing_vest);
  VESTMED(SlickBlackRock_vest);
  VESTMED(SlickD3CRX_vest);
  VESTMED(SlickMK3_vest);

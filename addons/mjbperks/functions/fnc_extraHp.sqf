...
if (_perkName in mjb_activePerks) exitWith { 
	...
	if (isNil "ace_medical_engine") then {
		...
		ace_medical_playerDamageThreshold = mjb_defaultDamage;
		ace_medical_painUnconsciousThreshold = mjb_defaultPain;
	};
};
// perk effects
if (isNil "ace_medical_engine") then {
	...
	mjb_defaultDamage = ace_medical_playerDamageThreshold;
	mjb_defaultPain = ace_medical_painUnconsciousThreshold;

	ace_medical_playerDamageThreshold = ace_medical_playerDamageThreshold * mjb_extraHpMult;
	ace_medical_painUnconsciousThreshold = ace_medical_painUnconsciousThreshold * mjb_extraHpMult;
};

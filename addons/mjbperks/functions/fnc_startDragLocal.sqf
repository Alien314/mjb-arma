...
if (_target isKindOf "CAManBase") then {
	...
	if (stance _unit isEqualTo "PRONE") then {[_target, "amovppnemstpsnonwnondnon", 2] call EFUNC(common,doAnimation);
    } else { [_target, "AinjPpneMrunSnonWnonDb_grab", 2] call EFUNC(common,doAnimation); };
};

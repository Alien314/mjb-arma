...
0: object
1: _xCount - number - x grid count (-east/+west)
2: _yCount - number - grid count (-south/+north)
3: _zStep - number - grid offset (-down/+up)
4: _stepX - boolean - true to add _zStep to Z on X grid, otherwise adds on Y grid
5: _xAdd - float - additional X offset to create/reduce gap between the created objects
6: _yAdd - float - additional Y offset to create/reduce gap between the created objects

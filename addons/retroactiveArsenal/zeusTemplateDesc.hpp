...
class CfgLoadouts
{
		...
		import rats from CfgLoadouts; // Gets MJB Arma v2 mod loadout file if available
	...
	#else // Fallback in case mod version is not available
...
missionGroup = "PersisTest"; // Change this to create your own persistent mission group

class Params {
	class mjb_zeusPersistGroup {
